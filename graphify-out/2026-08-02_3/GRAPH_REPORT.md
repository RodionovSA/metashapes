...
## Corpus Check
- 76 files · ~47,100 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1579 nodes · 5091 edges · 95 communities (62 shown, 33 thin omitted)
...
Cohesion: 0.16
Nodes (15): TestStripeSafeExtraction, CellMetrics, CellMetrics, Per-cell measurements produced by :class:`UnitCellAnalyzer`.      Attributes, Symbolic scaling of a shape., Symbolic scaling of a shape., Symbolic translation of a shape., Symbolic rotation of a shape. (+7 more)

### Community 7 - "Random Generator Logic"
Cohesion: 0.11
Nodes (7): _gen(), test_each_shape_type_generates(), TestBasicGeneration, TestConstraints, TestReport, TestShapeCount, TestShapeTypes
...
Cohesion: 0.08
Nodes (7): square_in_rect(), TestUnitCellSerialization, Symbolic regular polygon.      Parameters:         center: (cx, cy)         n: N, Symbolic regular polygon.      Parameters:         center: (cx, cy)         n: N, RegularPolygon, TestRegularPolygon, TestRegularPolygonDtypeDeviceGrad
...
Cohesion: 0.20
Nodes (7): _brute_force_sdf(), Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, test_matches_brute_force(), TestOffsetsForRing
...
Cohesion: 0.12
Nodes (8): Regular n-pointed star.      Parameters:         center: (cx, cy)         n: num, Regular n-pointed star.      Parameters:         center: (cx, cy)         n: num, Regular n-pointed star.      Parameters:         center: (cx, cy)         n: num, Star, assert_inside(), All points should have SDF < tol (inside or on boundary)., TestStar, TestStarDtypeDeviceGrad
...
Cohesion: 0.14
Nodes (10): _cell_center(), Rectangular cell with a Rectangle shape centred at (cx, cy)., The geometric midpoint (a1 + a2) / 2 as plain floats., _rect_cell(), TestAlreadyCentered, TestBboxRectangular, TestCentroidMethod, TestChaining (+2 more)
...
Cohesion: 0.10
Nodes (21): SDF Convention: Negative Inside, Positive Outside, assert_bounds_contain(), assert_direct_call_dtype_promotion(), assert_dtype_device_flow(), assert_gradients_finite(), assert_outside(), _assert_param_grads_finite(), assert_round_trip() (+13 more)
...
Cohesion: 0.09
Nodes (13): Parametric Serialization (to_parametric / from_parametric), min_feature_size(), min_feature_size(), min_feature_size(), Base class for all symbolic 2D shapes., Base class for all symbolic 2D shapes., Shape, SHAPE_REGISTRY Dict (+5 more)

### Community 53 - "Community 53"
Cohesion: 0.14
Nodes (12): p(), pv(), Shorthand: make a scalar nn.Parameter., Shorthand: make a vector nn.Parameter., TestBarSafeExtraction, TestCrossSafeExtraction, TestEllipseSafeExtraction, TestIsoscelesTrapezoidSafeExtraction (+4 more)

### Community 55 - "Community 55"
Cohesion: 0.17
Nodes (12): _compute_min_gap, Rotation Guard for Infinite-Extent Shapes, _bbox_size(), _compute_min_gap(), Compute all metrics for a single cell., True if this periodic shift should be skipped for self-gap measurement.      A s, Minimum distance between any two shapes (or a shape and its own periodic     ima, _skip_self_shift() (+4 more)

### Community 61 - "Community 61"
Cohesion: 0.16
Nodes (6): TestCompoundShapesToShapely, TestOffsetSearchOverhead, Symbolic rectangle.      Parameters:         center: (cx, cy)         size: (wid, Symbolic rectangle.      Parameters:         center: (cx, cy)         size: (wid, Rectangle, TestRectangleDtypeDeviceGrad
...
Cohesion: 0.12
Nodes (21): Smooth Boolean Operations via Polynomial Blending, from_parametric(), min_feature_size(), Tensor -> JSON/YAML-serializable Python value.     Scalar tensor -> Python scala, Tensor -> JSON/YAML-serializable Python value.     Scalar tensor -> Python scala, Tensor -> JSON/YAML-serializable Python value.     Scalar tensor -> Python scala, to_plain_data(), Difference (+13 more)
...
Cohesion: 0.20
Nodes (7): DefaultUnitCellValidator, validate(), method='centroid' on a shape that Shapely can represent should work., TestInfiniteBoundsError, A periodic structure: one Lattice + one Shape (the scene).      The lattice owns, A periodic structure: one Lattice + one Shape (the scene).      The lattice owns, UnitCell
...
Cohesion: 0.25
Nodes (6): For a symmetric Rectangle, both methods produce the same offset., For a centred Ellipse, both methods produce the same offset., Extract the outermost Translate dx/dy buffers from the scene., TestBboxHexagonal, TestSymmetricShapeConsistency, _translate_offset()
...
- **Why does `Shape` connect `Community 52` to `Shape Primitives Core`, `Random Generator & Lattice`, `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `Conic Shape Primitives`, `Shapely Transform Tests`, `Shapely Compound Shape Tests`, `Generator Integration Tests`, `Generator Base Classes`, `Community 11`, `Shapely Adapter Modules`, `Unit Cell Tests`, `Shapely Adapter Layer`, `Lattice SDF Tests`, `Coordinate Transform Bridge`, `Periodic Unit Cell Ops`, `Community 25`, `Lattice Test Init`, `Lattice Basis Rationale`, `Lattice Basis Rationale B`, `Validator Rationale`, `Generator Base Rationale`, `Community 55`, `Community 61`, `Community 65`, `Community 69`, `Community 70`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `Rectangle` connect `Community 61` to `Random Generator & Lattice`, `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `YAML Serialization Tests`, `Shapely Transform Tests`, `Random Generator Logic`, `Shapely Compound Shape Tests`, `Generator Integration Tests`, `Shapely Adapter Modules`, `YAML & Unit Cell Serialization`, `Unit Cell Tests`, `PyTorch Differentiability`, `Lattice SDF Tests`, `Boolean Shape Tests`, `Community 24`, `Community 25`, `Shape Test Init`, `Adapters Test Init`, `Lattice Basis Rationale`, `Community 52`, `Community 53`, `Community 55`, `Community 65`, `Community 74`, `Community 75`, `Community 76`, `Community 77`, `Community 79`, `Community 80`, `Community 82`, `Community 86`, `Community 91`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `UnitCell` connect `Community 75` to `Shape Primitives Core`, `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `YAML Serialization Tests`, `Shapely Transform Tests`, `Random Generator Logic`, `Shapely Compound Shape Tests`, `Community 11`, `YAML & Unit Cell Serialization`, `Unit Cell Tests`, `PyTorch Differentiability`, `Boolean Shape Tests`, `Community 24`, `Community 25`, `Shape Test Init`, `Adapters Test Init`, `Lattice Basis Rationale`, `Community 52`, `Community 53`, `Community 55`, `Community 61`, `Community 74`, `Community 76`, `Community 77`, `Community 80`, `Community 82`, `Community 86`?**
