...
## Corpus Check
- 76 files · ~47,297 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1585 nodes · 5099 edges · 92 communities (63 shown, 29 thin omitted)
...
Cohesion: 0.20
Nodes (13): cell_area(), device(), dtype(), hexagonal(), matrix(), Coerce a constructor scalar to float, refusing grad-carrying tensors.      ``rec, rectangular(), _scalar() (+5 more)

### Community 1 - "Random Generator & Lattice"
Cohesion: 0.11
Nodes (13): _decompose_for_offsets(), Periodic signed distance of the scene at Cartesian (x, y).          Query points, Return world-coordinate points on the material boundary (zero-level-set)., Yield sub-shapes to measure separately when sizing the periodic     copy search,, Return world-coordinate points on the material boundary (zero-level-set)., Return world-coordinate points on the material boundary (zero-level-set)., Shapely geometry of the scene, clipped to the unit cell.          Periodic, matc, Number of periodic copies to search per lattice direction.          A finite sha (+5 more)

### Community 2 - "Shape Analysis & SDF Concepts"
Cohesion: 0.14
Nodes (13): UnitCellAnalyzer, Return a list of constraint violation descriptions.         An empty list means, Generator-compatible interface.          Returns the first constraint violation, Compute metrics for every cell in a batch., Find groups of cells that have identical SDFs (within tolerance).          Each, Computes metrics for :class:`~metashapes.unit_cell.UnitCell` objects and     val, UnitCellAnalyzer, _cell() (+5 more)

### Community 3 - "Unit Cell Analyzer"
Cohesion: 0.05
Nodes (53): ABC, register_shape_sampler(), Lattice, Cartesian translation for lattice cell (i, j)., Cartesian (x, y) -> fractional (f1, f2)., Fractional (f1, f2) -> Cartesian (x, y)., Cartesian translation for lattice cell (i, j)., In-plane periodicity of the unit cell.     Defined by two lattice vectors. A rec (+45 more)

### Community 4 - "Conic Shape Primitives"
Cohesion: 0.12
Nodes (5): SDF Convention: Negative Inside, Positive Outside, sdf_at(), test_matches_brute_force_nearest_point(), TestEllipse, test_matches_brute_force_nearest_point()
...
Cohesion: 0.18
Nodes (14): TestBarSafeExtraction, TestCrossSafeExtraction, TestIsoscelesTrapezoidSafeExtraction, TestRegularPolygonSafeExtraction, TestStadiumSafeExtraction, TestStripeSafeExtraction, Symbolic scaling of a shape., Symbolic scaling of a shape. (+6 more)
...
Cohesion: 0.09
Nodes (12): Cross, Symbolic T-shape.      Parameters:         center: (cx, cy)         length: full, Symbolic T-shape.      Parameters:         center: (cx, cy)         length: full, Symbolic T-shape.      Parameters:         center: (cx, cy)         length: full, Symbolic symmetric cross.      Parameters:         center: (cx, cy)         leng, TShape, Shape, assert_inside() (+4 more)
...
Cohesion: 0.12
Nodes (8): IsoscelesTrapezoid, Symbolic isosceles trapezoid.      Parameters:         center: (cx, cy), Symbolic isosceles trapezoid.      Parameters:         center: (cx, cy), Symbolic isosceles trapezoid.      Parameters:         center: (cx, cy), Symbolic isosceles trapezoid.      Parameters:         center: (cx, cy), Symbolic isosceles trapezoid.      Parameters:         center: (cx, cy), TestIsoscelesTrapezoid, TestIsoscelesTrapezoidDtypeDeviceGrad

### Community 16 - "PyTorch Differentiability"
Cohesion: 0.12
Nodes (13): _brute_force_sdf(), Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, Independent reference: fold into the cell, then search a ring far     larger tha, sdf() after the L-02/L-03 rewrite must agree with a large brute-force     refere, sdf() must agree with a large brute-force reference search for a     variety of, sdf() after the L-02/L-03 rewrite must agree with a large brute-force     refere (+5 more)

### Community 17 - "Lattice SDF Tests"
Cohesion: 0.11
Nodes (6): ConvexQuad, Symbolic convex quadrilateral with optional rounded corners.      The quad is bu, Symbolic convex quadrilateral with optional rounded corners.      The quad is bu, Symbolic convex quadrilateral with optional rounded corners.      The quad is bu, TestConvexQuad, TestConvexQuadDtypeDeviceGrad
...
Cohesion: 0.20
Nodes (16): assert_bounds_contain(), assert_direct_call_dtype_promotion(), assert_dtype_device_flow(), assert_gradients_finite(), assert_outside(), _assert_param_grads_finite(), assert_round_trip(), Calling sdf() directly on a primitive (bypassing UnitCell) with     float64 quer (+8 more)

### Community 29 - "Adapters Test Init"
Cohesion: 0.07
Nodes (18): _ellipse_closest_point(), Nearest point on the boundary of an axis-aligned ellipse (semi-axes     a, b, ce, ConvexQuadSDF(), IsoscelesTrapezoidSDF(), SDF for an isosceles trapezoid, symmetric about the y-axis.      The bottom base, SDF for a convex quadrilateral.      Corners sit at +-u +-v, with the far corner, SDF for a rectangle.           Parameters:          hx: Half of the rectangle si, RectangleSDF() (+10 more)
...
Cohesion: 0.07
Nodes (33): Parametric Serialization (to_parametric / from_parametric), Smooth Boolean Operations via Polynomial Blending, min_feature_size(), min_feature_size(), min_feature_size(), from_parametric(), min_feature_size(), Tensor -> JSON/YAML-serializable Python value.     Scalar tensor -> Python scala (+25 more)

### Community 53 - "Community 53"
Cohesion: 0.17
Nodes (7): p(), pv(), Shorthand: make a scalar nn.Parameter., Shorthand: make a vector nn.Parameter., TestEllipseSafeExtraction, TestRectangleSafeExtraction, TestTransformSafeExtraction

### Community 55 - "Community 55"
Cohesion: 0.15
Nodes (17): CellMetrics, _compute_min_gap, Rotation Guard for Infinite-Extent Shapes, _bbox_size(), CellMetrics, _compute_min_gap(), Compute all metrics for a single cell., True if this periodic shift should be skipped for self-gap measurement.      A s (+9 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (6): TestCompoundShapesToShapely, Symbolic rectangle.      Parameters:         center: (cx, cy)         size: (wid, Symbolic rectangle.      Parameters:         center: (cx, cy)         size: (wid, Rectangle, TestRectangle, TestRectangleDtypeDeviceGrad
...
Cohesion: 0.18
Nodes (3): Ellipse, Symbolic ellipse.      Parameters:         center: (cx, cy)         axes: full s, TestEllipse

### Community 70 - "Community 70"
Cohesion: 0.37
Nodes (4): _leaf_shapes, _leaf_shapes(), Yield leaf (primitive) shapes from a composed shape tree.      Union nodes are d, TestLeafShapes
...
Cohesion: 0.20
Nodes (8): Rasterize the periodic structure into a mask. Shape [ny·n2, nx·n1].          sof, Periodic SDF sampled over a supercell.          repeat=(n1, n2) — tile n1 cells, Rasterize the periodic structure into a mask. Shape [ny·n2, nx·n1].          sof, Rasterize the periodic structure into a mask. Shape [ny·n2, nx·n1].          sof, Axis-aligned Cartesian bounding box of the supercell.          Returns ``(xmin,, Axis-aligned Cartesian bounding box of the supercell.          Returns ``(xmin,, Axis-aligned Cartesian bounding box of the supercell.          Returns ``(xmin,, Periodic SDF sampled over a supercell.          repeat=(n1, n2) — tile n1 cells

### Community 75 - "Community 75"
Cohesion: 0.11
Nodes (9): square_in_rect(), method='centroid' on a shape that Shapely can represent should work., TestInfiniteBoundsError, TestOffsetSearchOverhead, TestOffsetsForRing, TestToShapely, A periodic structure: one Lattice + one Shape (the scene).      The lattice owns, A periodic structure: one Lattice + one Shape (the scene).      The lattice owns (+1 more)
...
Cohesion: 0.06
Nodes (37): _centroid(), TestBooleansToShapely, TestPrimitivesToShapely, TestTransformsToShapely, Shapely Adapter Pattern, difference_to_shapely(), intersection_to_shapely(), union_to_shapely() (+29 more)

### Community 79 - "Community 79"
Cohesion: 0.33
Nodes (3): center_scene(method='centroid') must work even if params have grad., Verifies that calling shape_to_shapely (which does .detach().cpu())         does, TestUnitCellSafeExtraction
...
- **Why does `Shape` connect `Community 52` to `Shape Primitives Core`, `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `Conic Shape Primitives`, `Shapely Transform Tests`, `Shapely Compound Shape Tests`, `Generator Integration Tests`, `Generator Base Classes`, `Community 11`, `Shapely Adapter Modules`, `Unit Cell Tests`, `Shapely Adapter Layer`, `Lattice SDF Tests`, `Coordinate Transform Bridge`, `Periodic Unit Cell Ops`, `Community 25`, `Lattice Test Init`, `Lattice Basis Rationale`, `Lattice Basis Rationale B`, `Validator Rationale`, `Generator Base Rationale`, `Community 55`, `Community 61`, `Community 65`, `Community 69`, `Community 71`, `Community 77`?**
  _High betweenness centrality (0.153) - this node is a cross-community bridge._
- **Why does `UnitCell` connect `Community 75` to `Shape Primitives Core`, `Random Generator & Lattice`, `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `YAML Serialization Tests`, `Shapely Transform Tests`, `Random Generator Logic`, `Shapely Compound Shape Tests`, `Community 11`, `YAML & Unit Cell Serialization`, `PyTorch Differentiability`, `Boolean Shape Tests`, `Community 24`, `Community 25`, `Lattice Basis Rationale`, `Community 52`, `Community 53`, `Community 55`, `Community 70`, `Community 74`, `Community 76`, `Community 79`, `Community 90`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `Rectangle` connect `Community 61` to `Shape Analysis & SDF Concepts`, `Unit Cell Analyzer`, `YAML Serialization Tests`, `Shapely Transform Tests`, `Random Generator Logic`, `Shapely Compound Shape Tests`, `Generator Integration Tests`, `Shapely Adapter Modules`, `YAML & Unit Cell Serialization`, `PyTorch Differentiability`, `Lattice SDF Tests`, `Boolean Shape Tests`, `Community 24`, `Community 25`, `Adapters Test Init`, `Lattice Basis Rationale`, `Community 52`, `Community 53`, `Community 55`, `Community 65`, `Community 70`, `Community 75`, `Community 76`, `Community 77`, `Community 79`, `Community 90`?**
